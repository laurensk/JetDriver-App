export class ApiErrorTranslation {
  static translation: any = {
    ...
    UNAUTHENTICATED:
      'Du bist derzeit nicht angemeldet. Bitte start die App neu, um dich erneut anzumelden.',
    INVALID_TOKEN:
      'Du bist derzeit nicht angemeldet. Bitte start die App neu, um dich erneut anzumelden.',
    VALIDATION_ERROR:
      'Die eingegebenen Daten sind falsch bzw. nicht gültig. Bitte überprüfe deine Eingabe erneut.',
